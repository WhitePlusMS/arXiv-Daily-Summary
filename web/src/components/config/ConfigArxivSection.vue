<template>
  <div class="ui-form-container">
    <div class="ui-card">
      <h3 class="ui-card-title">API 请求设置</h3>
    ...
    <div class="ui-card">
      <h3 class="ui-card-title">筛选与生成策略</h3>
      <div class="ui-form-group">
        <label>单次最大拉取数 (MAX_ENTRIES)</label>
        <input type="number" v-model="config.MAX_ENTRIES" />
        <p class="ui-help-text">每次从 ArXiv 获取的论文最大数量，建议不要超过 100。</p>
      </div>
      <div class="ui-form-row">
        <div class="ui-form-group">
          <label>详细解读数量</label>
      ...
      <div class="ui-form-group">
        ...
        <p class="ui-help-text">低于此分数的论文将被自动过滤。推荐值: 6</p>
      </div>
    </div>
  </div>
</template>
